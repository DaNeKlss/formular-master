...
// eslint v8.46
// typescript-eslint v6.3

const possibleProblemRules = {
  "array-callback-return": "error",
  "no-constant-binary-expression": "error",
  "no-constructor-return": "error",
  // "no-duplicate-imports": "error", // doesn't understand type imports
...
const tsRules = {
  ...
  // "@typescript-eslint/prefer-readonly-parameter-types": "warn", // making readonly types is verbose
...
export default [
  ...
  {
    ignores: [".angular/*", "eslint.config.js"],
  },
];
